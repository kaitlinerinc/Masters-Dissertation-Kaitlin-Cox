...
unrelated_vulnerability <- c("lives", "life", "consequence", "sense", "consequences", "ultimately", "self", "spite", "situation",
                             ...
                             "point", "always", "absences", "contraries",
                             ...
                             "conflicts", "confusions", "denials", "depended",
                             "depending", "depends", "described", "describes", "describing", "desired", "overcome", "overcame", "overcomes", "overcoming",
...
unrelated_charity <- c("must", "another", "one", "upon", "besides", "part", "also", "promise", "hope", "peace", "necessary",
                       ...
                       "responsible", "takes", "mention", "efforts", "comes", "keep", "bring", "brought", "care",
                       ...
                       "sent", "thankful", "friends", "set", "expect", "just", "anybody", "decided",
                       "establish", "enter", "advance", "please", "going", "deserve", "appreciate", "somebody",
                       "reward", "receiving", "helps", "since", "begin", "nobody", "wonderful", "home",
                       "luck", "name", "plan", "rescue", "free", "actions", "today", "little",
                       ...
                       "next", "sometimes", "try", "getting", "sending", "appreciation", "worth", "suggest", "pay",
                       ...
                       "offer", "normally", "close", "probably", "included", "current", "active", "grace",
                       "behind", "gratitude", "glad", "second", "pleased", "shared", "ultimate", "message",
                       ...
                       "bears", "began", "beginnings", "begins", "begun", "behinds", "behinds.", "beloveds", "benefited",
                       "benefiting", "benefitted", "benefitting", "bore", "born", "borne", "cased", "cases", "casing",
                       ...
                       "offerings", "organizations", "outsides", "paid", "participated", "participates",
...
# Prints 10 random examples per dictionary word with +/- 5 words context
# ==============================================================================

print_random_dictionary_examples <- function(df,
                                             dictionary,
                                             dictionary_name,
  ...
  for(target_word in dictionary) {
    ...
    # Randomly sample up to requested number
    if(nrow(word_examples) > examples_per_word) {
      word_examples <- word_examples[sample(
        seq_len(nrow(word_examples)),
        examples_per_word
      ), ]
    }
    ...
    for(j in seq_len(nrow(word_examples))) {
      ...
      context <- str_replace(
        context,
        paste0("\\b", target_word, "\\b"),
        paste0(">>> ", toupper(target_word), " <<<")
      )
...
print_random_dictionary_examples(
  results_df,
  expanded_dictionaries$charity_agency,
  "CHARITY_AGENCY",
  examples_per_word = 10
)
